...
module "billing-alert" {
  ...
  source                = "github.com/dgourillon/fast-fabric-modules/factories/billing-budget"
...
module "dns" {
  source          = "github.com/dgourillon/fast-fabric-modules/factories/dns"
...
module "project" {
  source                     = "github.com/dgourillon/fast-fabric-modules/factories/project"
  billing_account            = local.billing_account_id
  name                       = var.project_id
  prefix                     = var.prefix
...
module "service-accounts" {
  source     = "github.com/dgourillon/fast-fabric-modules/factories/iam-service-account"
